...
switch ($_POST['function']) {
    ...
    case 'get-articles':
        die(sb_ajax_response(sb_get_articles(sb_post('id', -1))));
...
function sb_security() {
    ...
    $security = [
        ...
        'user' => ['update-user', 'get-user', 'get-user-extra', 'update-user-to-lead', 'new-conversation', 'get-user-conversations', 'get-new-user-conversations', 'send-slack-message', 'slack-unarchive', 'update-message', 'delete-message', 'update-user-and-message', 'get-conversation', 'get-new-messages'],
